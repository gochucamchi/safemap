# -*- coding: utf-8 -*-
"""
Naver Geocoding API를 사용한 주소 → 좌표 변환 서비스
- 한국 주소에 최적화
- 하루 10만건 무료
- Kakao보다 정확함
"""
...
def get_geocoding_service(client_id: str, client_secret: str) -> NaverGeocodingService:
    """지오코딩 서비스 인스턴스 반환"""
    global _geocoding_service
    if _geocoding_service is None:
        _geocoding_service = NaverGeocodingService(client_id, client_secret)
